...
public class UserController {
  ...
  @GetMapping(value = "/ranked", produces = MediaType.APPLICATION_JSON_VALUE, params = {"length",
      "poolSize", "order=count"})
  ...
  public Iterable<ScoreSummary> getRankingsByTime(@RequestParam int length,
      @RequestParam int poolSize) {
    return service.getRankingsStatisticsByTime(length, poolSize);
  }
}
